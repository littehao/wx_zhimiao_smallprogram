<template>
	<view class="search-suggest">
		<comheader  title="地图选点"></comheader>	
...
<script>
	...
	import tuiDivider from '@/pagesA/components/tui-divider/tui-divider.vue'
	...
	export default {
		components:{tuiDivider,tuiListCell,tuiLoadmore},
		data() {
			return {
				keywords: '',
		...
		methods: {
			...
			getSuggest(keywords) {
				...
				this.qqmapsdk.getSuggestion({
					keyword: keywords,
					region:this.currentLocation.cityName,
					location:`${this.currentLocation.lat},${this.currentLocation.lng}`,
