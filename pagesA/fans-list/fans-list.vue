				...
				<view class="px-32 bgffff">
					<block  v-for="item in focusList" :key="item.id">
					  <view class="flex py-3">
						...
						<view class="fs-24 ftffff flex align-center justify-center rounded" :class="item.focus?'bgFCB6A4':'bgF85241'" style="width: 60px;height: 24px;" @click="focusItemFn(item)">{{item.focus?'已关注':'回粉'}}</view>
					  </view>
					</block>
				</view>
			</mescroll-uni>
