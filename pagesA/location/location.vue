<template>
	<view class="container">
		<map id="maps" class="tui-maps" show-location :longitude="longitude" :latitude="latitude" :scale="16"
			...
			<!-- #ifndef MP-ALIPAY -->
			<cover-image class="tui-cover-back" src="/pagesA/static/images/icon_back_3x.png" @tap.stop="back" />
			<cover-image class="tui-cover-image" :class="{ 'tui-ani': ani }"
				src="/pagesA/static/images/icon_marker_3x.png" />
			<cover-image src="/pagesA/static/images/icon_location_3x.png" class="tui-current-img"
				@tap="currentLocation"></cover-image>
			<!-- #endif -->
		</map>
		<!-- #ifdef MP-ALIPAY -->
		...
		<view class="tui-search__box">
			<view class="thorui-flex__center flex align-center px-1" @tap="search">
					...
					<tui-list-cell padding="30rpx">
						<view class="tui-list__item">
							...
							<view class="tui-radio-box">
								<radio color="#F53F3F" :value="index.toString()"></radio>
							</view>
						</view>
					</tui-list-cell>
				</label>
		...
		<view class="tui-btn__box">
			<tui-form-button background="#F85241" disabledGray :disabled="index == -1" height="72rpx" shape="circle" :size="30" @click="btnFix">确定</tui-form-button>
			<view class="tui-seize__seat"></view>
		</view>
	</view>
</template>
