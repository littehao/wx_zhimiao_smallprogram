...
var _httpRequest = _interopRequireDefault(__webpack_require__(/*! @/utils/httpRequest */ 40));
...
_vue.default.mixin(_debounce.default);
// Vue.mixin(share)
...
var _timWxSdk = _interopRequireDefault(__webpack_require__(/*! tim-wx-sdk */ 34));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
var _default = {
  onLaunch: function onLaunch() {
    ...
    uni.$TUIKit = _timWxSdk.default.create(options); // SDK 实例通常用 tim 表示
    ...
    uni.getSystemInfo({
      success: function success(res) {
        ...
        _this.$store.commit("setSafeAreaBottom", Math.abs(res.safeAreaInsets.bottom) > 0 ? Math.abs(res.safeAreaInsets.bottom) : 10);
    ...
    //判断是否登录 获取用户信息
    var token = this.tui.getToken();
    var user = this.tui.getUser();
    console.log(user);
    if (token && user) {
  ...
  onShow: function onShow() {
    ...
    // 获取本地定位信息
    var axis = this.tui.getStorage('axis');
    if (axis) {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapActions)(['verificationToken', 'getUserSig'])), {}, {
    verificationTokenFn: function verificationTokenFn(token, user) {
      var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this2.verificationToken();
              case 3:
                res = _context.sent;
                if (res.code == 200) {
                  _this2.$store.commit('setisLogin', true);
                  _this2.$store.commit('setToken', token);
                  _this2.$store.commit('setUser', user);
                  //开发登录im
                  uni.$TUIKit.login({
                    userID: user.id,
                    userSig: _this2.tui.getStorage('userSig')
                    ...
                    if (imError.code == 6206 || imError.code == 70003 || imError.code == 70001) {
                      _this2.getUserSigFn(user.id); //UserSig 过期，请重新获取有效的 UserSig 后再重新登录
                    }
              ...
              case 7:
                ...
                _this2.$store.commit('setToken', null);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _this3.getUserSig();
              case 3:
                res = _context2.sent;
                if (res.code == 200) {
                  _this3.tui.setStorage('userSig', res.data);
                  console.log(userID);
                  uni.$TUIKit.login({
                    userID: userID,
                    userSig: res.data
